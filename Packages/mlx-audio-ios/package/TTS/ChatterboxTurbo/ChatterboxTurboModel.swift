...
class ChatterboxTurboModel: Module {
  ...
  func prepareConditionals(
    ...
    // Prefill conditioning through transformer and cache KV states
    // This avoids reprocessing ~376 conditioning tokens for each generation call
    t3.prefillConditioning(&t3Cond)
